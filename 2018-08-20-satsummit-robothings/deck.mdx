...
![](https://gist.githubusercontent.com/daniel-j-h/20f4c668f683336764041a9a5eab7b1e/raw/124ee3d7d7628c1d60d3609d0b6515995ed2781d/pipeline.gif)
 ...
 🙏  [Daniel](https://github.com/daniel-j-h) and [Bhargav](https://github.com/bkowshik/).

```notes
The prediction core is a segmentation model — a fully convolutional neural net which we train on pairs of images and masks. 
...
- [OSM changeset](https://wiki.openstreetmap.org/wiki/Changeset) validation.
- Locate features which should be mapped.
- Determine map compeletion for specific features in specific regions.
- Integration/enhancement of existing processing piplines.
...
An API will make your life simpler.
...
We've used Nvidia GTX 1080 TIs and AWS' p2 & p3 instances. I'm interested in getting this running on SageMaker. Lots of options.
...
rs rasterize
Rasterize the GeoJSON features which you're interested in predicting into mask images which we'll train our model with.
```
...
```notes
Data went out via USB drive

TODO: Describe contents - folder structure post `rs rasterize`
...
```notes
TODO: Provide intermediate data
```

---

# Examples: OSM Diaries
